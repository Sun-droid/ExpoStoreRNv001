            ...
            <View style={{ flex: 1 }}>
               ...
               <View style={styles.newProductContainer}>
                   <TextInput
                     ...
                     style={styles.newProductInput}
                     value={newProduct}
                     onChangeText={() => {setNewProduct(), (name) => this.onChangeText(name), (value) => setTextInputName(value)}}
                     ref={e => this._e= e}
                   />
                   <TextInput
                      style={styles.newProductInput}
                  ...
                  <TouchableOpacity
                        style={checkTextInput ? styles.active : styles.disaled}
                        onPress={()=> {
                           if (checkTextInput) {
                              console.log("Success")
                           } else {
                     ...
                     >
                      <Pressable style={styles.button} onPress={()=>{handleCreateProduct(), handleModal()}} disabled={false}>
                          <Text style={styles.textStyle}>Save</Text>
                     </Pressable>
                  </TouchableOpacity>
               </View>
